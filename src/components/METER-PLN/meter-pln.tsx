...
const MeterPlnCard: React.FC<SungaiCardProps> = ({
  title,
  nilaiSebelumnya,
  nilaiSekarang,
  onAction,
    ...
    <div className={`p-4 mb-4 shadow-none rounded-xl ${bgColor}`}>
      <div className="flex justify-between items-center">
        ...
        >
          ...
          <span className="text-center text-xs">{waktuCatat}</span>
        </div>
      </div>
        ...
        <div className="flex flex-col justify-between flex-1 text-xs ">
          <div>
            ...
            <p className="flex justify-between py-1 ">
              <span>
                Stand <span className="capitalize">{type}</span> Sebelumnya:
              </span>
              <span>{nilaiSebelumnya === 0 ? "-" : nilaiSebelumnya}</span>
            </p>
            <div className="my-1 border-b border-gray-300" />
            <p className="flex justify-between py-1 ">
              <span>
                Stand <span className="capitalize">{type}</span> Sekarang:
              </span>
              <span>{nilaiSekarang === 0 ? "-" : nilaiSekarang}</span>
            </p>
          </div>
