...
interface SungaiCardProps {
  ...
  bgColor?: string;
  btnColor?: string;
  levelSungaiSebelumnya?: number;
  levelSungaiSekarang?: number;
  waktuCatat?: string | null;
  isPast: boolean;
}

const SungaiCard: React.FC<SungaiCardProps> = ({
  title,
  levelSungaiSebelumnya,
  levelSungaiSekarang,
  onAction,
  titleAction,
  image,
        ...
        <div className="w-24 aspect-[4/3] h-auto flex-shrink-0">
          <div className="w-full h-full overflow-hidden rounded-md">
            <img
              ...
              onClick={() => setOpen(true)} // klik buat buka lightbox
            />
          </div>
        </div>
        ...
        <div className="flex flex-col justify-between flex-1 text-xs ">
          <div>
            ...
            <p className="flex justify-between py-1 ">
              <span>Level Sungai Sebelumnya:</span>
              <span>
                {levelSungaiSebelumnya === 0 ? "-" : levelSungaiSebelumnya} cm
              </span>
            </p>
            <div className="my-1 border-b border-gray-300" />
            <p className="flex justify-between py-1 ">
              <span>Level Sungai Sekarang:</span>
              <span>
                {levelSungaiSekarang === 0 ? "-" : levelSungaiSekarang} cm
              </span>
            </p>
          </div>
