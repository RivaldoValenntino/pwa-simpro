...
import { isInShiftMalam, isInShiftPagi } from "../utils/date-helper";
      ...
      <div className="w-full p-4 rounded-xl">
            ...
            {shouldShowNextShiftButton && isPengawas === 0 && (
              <button
                ...
                onClick={() => {
                  ...
                  if (
                    (shiftUser === "Pagi" &&
                      !isInShiftPagi(hoursServer, minutesServer)) ||
                    (shiftUser === "Malam" &&
                      !isInShiftMalam(hoursServer, minutesServer))
                  ) {
        ...
        <div className="grid grid-cols-4 gap-4">
          {filteredSlots.map(({ time, val }) => {
            ...
            const isWaktuShiftP = hoursServer >= 8 && hoursServer <= 19;
            const isWaktuShiftM = hoursServer >= 20 || hoursServer <= 7;
              ...
              <button
                ...
                onClick={() => {
                  ...
                  if (isActive) {
                    ...
                    navigate({ to: `/list-data`, search: { jam: val } });
                  }
                }}
                disabled={!isActive}
