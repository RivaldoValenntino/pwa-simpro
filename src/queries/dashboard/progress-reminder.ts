...
export const getProgressReminder = async (
  jam: number,
...
export const fetchProgressReminder = (
  jam: number,
  tanggal: string | undefined
) =>
  queryOptions({
    queryKey: ["fetchProgressReminder", jam, tanggal],
    queryFn: () => getProgressReminder(jam, tanggal),
    retry: false,
